...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/lakki99/BrandrdXMusic",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/lakkis_botz")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/lakkis_botz")
