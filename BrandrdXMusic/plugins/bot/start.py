...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await message.reply_sticker("CAACAgIAAxkBAANoahWYvZo4eizD0-xgVSrZaRbLlIMAAsYXAAKUtRhLmw8UNgKy6MseBA")
        ...
        try:
            ...
            await lols.edit_text("**⚡ѕтαятιиg.**")
            await lols.edit_text("**⚡ѕтαятιиg....**")
            m = await message.reply_sticker("CAACAgIAAxkBAANoahWYvZo4eizD0-xgVSrZaRbLlIMAAsYXAAKUtRhLmw8UNgKy6MseBA")
